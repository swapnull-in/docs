...
```bash cURL
curl -X GET https://billing.example.com/v1/customers/cust_abc123/churn \
...
```bash cURL
curl -X GET "https://billing.example.com/v1/churn/high-risk?threshold=0.7" \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X GET https://billing.example.com/v1/churn/alerts \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X POST https://billing.example.com/v1/churn/alerts/alert_001/acknowledge \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
