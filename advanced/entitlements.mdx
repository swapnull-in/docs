...
```bash cURL
curl -X PUT https://billing.example.com/v1/plans/8f14e45f-.../entitlements \
...
```bash cURL
curl https://billing.example.com/v1/customers/1b9d6bcd-.../entitlements \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash
curl "https://billing.example.com/v1/entitlements/check?customer_id=1b9d6bcd-...&feature=api_access" \
  -H "Authorization: Bearer $API_KEY"
```
