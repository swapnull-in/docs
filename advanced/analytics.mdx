...
```bash cURL
curl -G https://api.recurso.dev/v1/analytics/usage \
  -H "Authorization: Bearer $API_KEY" \
...
```bash cURL
curl -G https://api.recurso.dev/v1/analytics/dunning/overview \
  -H "Authorization: Bearer $API_KEY" \
  -d start_date=2026-06-01 \
...
```bash cURL
curl -G https://api.recurso.dev/v1/analytics/dunning/history \
  -H "Authorization: Bearer $API_KEY" \
  -d start_date=2026-06-01 \
  -d end_date=2026-06-30 \
  -d limit=50
