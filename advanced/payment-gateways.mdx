...
<Steps>
  ...
  <Step title="Configure webhook endpoint">
    ...
    ```
    URL: https://billing.example.com/v1/webhooks/razorpay
...
<Steps>
  ...
  <Step title="Configure webhook endpoint">
    ...
    ```
    URL: https://billing.example.com/v1/webhooks/stripe
...
| Stripe | `card`, `ach_debit`, `sepa_debit` | International customers, USD billing |
