...
```bash cURL
curl -X POST https://billing.example.com/v1/cancel-flows \
...
```bash cURL
curl -X POST https://billing.example.com/v1/cancel-flows/sessions/start \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "customer_id": "cust_abc123",
...
```bash cURL
curl -X POST https://billing.example.com/v1/cancel-flows/sessions/cfs_session_001/submit \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "step_id": "step_survey_001",
...
```bash cURL
curl -X GET https://billing.example.com/v1/cancel-flows/sessions/cfs_session_001 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X GET https://billing.example.com/v1/cancel-flows/stats \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
