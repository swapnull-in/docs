...
```bash cURL
curl "https://api.recurso.dev/v1/ledger/entries?account_id=lacc_rev4000&start_date=2025-06-01&end_date=2025-06-30" \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Automate Reporting" icon="chart-line">
    Use the ledger API to build automated revenue reports rather than manual spreadsheets.
  </Card>
