...
```bash cURL
curl -X POST https://billing.example.com/v1/dunning-campaigns \
...
```bash cURL
curl -X GET https://billing.example.com/v1/invoices/inv_overdue_456/payment-wall \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X GET https://billing.example.com/v1/dunning-campaigns \
  -H "Authorization: Bearer $API_KEY"

curl -X GET https://billing.example.com/v1/dunning-campaigns/dc_abc123 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X PUT https://billing.example.com/v1/dunning-campaigns/dc_abc123 \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{ "name": "Aggressive Recovery", "payment_wall_grace_days": 3 }'

curl -X PUT https://billing.example.com/v1/dunning-campaigns/dc_abc123/steps/step_002 \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{ "day_offset": 2, "body": "Updated SMS content" }'

curl -X DELETE https://billing.example.com/v1/dunning-campaigns/dc_abc123/steps/step_004 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
