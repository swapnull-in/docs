...
```bash cURL
curl -X POST https://billing.example.com/v1/organizations \
...
<CodeGroup>
```typescript TypeScript
const orgs = await recurso.organizations.list({
  limit: 20,
  offset: 0
});
...
```bash cURL
curl -G https://billing.example.com/v1/organizations \
  -H "Authorization: Bearer $API_KEY" \
  -d limit=20
```
</CodeGroup>
...
```bash cURL
curl https://billing.example.com/v1/organizations/org_acme01 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
<CodeGroup>
```typescript TypeScript
const updated = await recurso.organizations.update('org_acme01', {
...
```bash cURL
curl -X PUT https://billing.example.com/v1/organizations/org_acme01 \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Acme Holdings International",
...
<CodeGroup>
```typescript TypeScript
await recurso.organizations.delete('org_acme01');
```

```bash cURL
curl -X DELETE https://billing.example.com/v1/organizations/org_acme01 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X POST https://billing.example.com/v1/organizations/org_acme01/tenants \
  -H "Authorization: Bearer $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "tenant_id": "tenant_brandx"
...
```bash cURL
curl https://billing.example.com/v1/organizations/org_acme01/tenants \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
<CodeGroup>
```typescript TypeScript
await recurso.organizations.removeTenant('org_acme01', 'tenant_brandz');
...
```bash cURL
curl -X DELETE https://billing.example.com/v1/organizations/org_acme01/tenants/tenant_brandz \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl https://billing.example.com/v1/organizations/org_acme01/analytics/mrr \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
