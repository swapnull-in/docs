...
```bash cURL
curl https://api.recurso.dev/v1/mandates/mdt_m3k7p9 \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl https://api.recurso.dev/v1/mandates \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
...
```bash cURL
curl -X POST https://api.recurso.dev/v1/mandates/mdt_m3k7p9/revoke \
  -H "Authorization: Bearer $API_KEY"
```
</CodeGroup>
