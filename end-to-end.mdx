...
sequenceDiagram
    ...
    R->>You: subscription.created webhook
...
<Info>
Grant access to your product when you receive `subscription.created`. See the [Webhooks guide](/advanced/webhooks) for signature verification.
</Info>
